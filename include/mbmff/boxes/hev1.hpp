...
template <>
struct mbmff::basic_box_view<mbmff::box_type::hev1> : public mbmff::box_view_base {
...
static_assert(
    !mbmff::basic_box_view<mbmff::box_type::hev1>::validate({mbmff::box_header{}, std::span<const std::byte>{}})
);

static_assert(static_cast<bool>(mbmff::basic_box_view<mbmff::box_type::hev1>::validate(
