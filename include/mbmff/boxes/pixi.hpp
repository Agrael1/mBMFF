...
inline constexpr auto basic_box_view<box_type::pixi>::validate(mbmff::any_box_view box) noexcept
...
inline constexpr auto basic_box_view<box_type::pixi>::value() const noexcept -> mbmff::pixi_data
{
