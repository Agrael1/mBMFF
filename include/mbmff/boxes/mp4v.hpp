...
static_assert(
    !mbmff::basic_box_view<mbmff::box_type::mp4v>::validate({mbmff::box_header{}, std::span<const std::byte>{}})
);

static_assert(static_cast<bool>(mbmff::basic_box_view<mbmff::box_type::mp4v>::validate(
